package org.comppress.android.adapter;
...
import org.comppress.android.activity.ReaderActivity;
...
public class ContentAdapter extends RecyclerView.Adapter<ContentAdapter.ContentViewHolder>{
    ...
    public void onBindViewHolder(@NonNull final ContentViewHolder holder, final int position) {
        ...
        if (content.getAverageRating() == 0) {
            holder.textViewRating.setText(context.getString(R.string.rating_null));
        } else {
